...
func (_c *AuthIdentityCreate) SetAccountID(v int64) *AuthIdentityCreate {
...
func (_c *AuthIdentityCreate) SetProviderAccountID(v string) *AuthIdentityCreate {
...
func (_c *AuthIdentityCreate) SetEmailVerified(v bool) *AuthIdentityCreate {
	_c.mutation.SetEmailVerified(v)
	return _c
}

// SetNillableEmailVerified sets the "email_verified" field if the given value is not nil.
func (_c *AuthIdentityCreate) SetNillableEmailVerified(v *bool) *AuthIdentityCreate {
	if v != nil {
...
func (_c *AuthIdentityCreate) check() error {
	...
	if _, ok := _c.mutation.AccountID(); !ok {
		return &ValidationError{Name: "account_id", err: errors.New(`ent: missing required field "AuthIdentity.account_id"`)}
	}
	...
	if _, ok := _c.mutation.ProviderAccountID(); !ok {
		return &ValidationError{Name: "provider_account_id", err: errors.New(`ent: missing required field "AuthIdentity.provider_account_id"`)}
	}
	if _, ok := _c.mutation.Email(); !ok {
		return &ValidationError{Name: "email", err: errors.New(`ent: missing required field "AuthIdentity.email"`)}
	}
	if _, ok := _c.mutation.EmailVerified(); !ok {
...
func (_c *AuthIdentityCreate) createSpec() (*AuthIdentity, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(authidentity.Table, sqlgraph.NewFieldSpec(authidentity.FieldID, field.TypeInt))
	)
